...
node-dogecoin is a Dogecoin client for Node.JS. It is a fork of the excellent git://github.com/Weltschmerz/Kapitalize.git ntended for use with Dogecoin. It's currently very nearly identical to Kaptialize, which can be used for Dogecoin too. The purpose of this repository is primarily:
